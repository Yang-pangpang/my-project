                ...
                <el-steps :active="activeStep" direction="vertical" process-status="process" finish-status="success">
                    ...
                    <el-step ref="step1">
                        ...
                        <template #description>
                            <div v-show="expandedStep === 'step1'"
                                class="text-xs mb-6 leading-5 text-[--text-default-1]">
                    ...
                    <el-step ref="step2">
                        <template #title>
                            <div class="flex pb-4 items-center justify-between cursor-pointer"
                        ...
                        <template #description>
                            <div v-show="expandedStep === 'step2'"
                                class="mt-2 mb-6 p-4 border border-[--border-2] rounded">
